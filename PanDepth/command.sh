...
do
    ...
    do
        ...
        do
            ...
            do
                /usr/bin/time -v sambamba depth region -c 0 -t ${thread} -L chr.bed -o sambamba.${readType}.sort.${fileType}_t${thread}_r${repeat}.txt ${readType}.sort.${fileType} 2>sambamba.${readType}.sort.${fileType}_t${thread}_r${repeat}.log
